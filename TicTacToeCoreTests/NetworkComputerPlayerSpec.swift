    ...
    override func spec() {
        ...
        describe("network player parameters") {
            ...
            it("includes the URL of the TTT API") {
                expect(ai.urlString).to(equal("https://dry-wave-85958.herokuapp.com/api/computer_move"))
            }
            ...
            it("uses the correct key for the client name query param") {
                expect(ai.clientNameKey).to(equal("client_name"))
            }
